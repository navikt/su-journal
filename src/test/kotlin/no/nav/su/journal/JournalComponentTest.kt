...
class JournalComponentTest {
    ...
    fun `når vi får en melding om en søknad som har blitt tilordnet en skyggesak i Gsak, men ikke journalført, så skal vi journalføre søknaden`() {
        withTestApplication({
            ...
            stubSuPdfGen()
            val sakId = "1"
            val nySøknadMedSkyggesak = NySøknadMedSkyggesak(correlationId = "cora", sakId = sakId, søknadId = "2", søknad = """{"key":"value"}""", fnr = "12345678910", aktørId = "1234567891011", gsakId = "6")
